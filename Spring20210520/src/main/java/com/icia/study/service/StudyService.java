...
public class StudyService {
	...
	public ModelAndView selectDB() {
		...
		// DB에서 조회한 내용을 ArrayList에 담음 (List -> java.util.List import 시키고)
		...
		mav.setViewName("select"); // 어디로 갈건지
		
		// 그냥 화면으로 갈때는 컨트롤러에서 String 리턴만 하면 되지만 (화면만=String)
		// 어떤 데이터를 가지고 갈때는 mav 이용 (화면+데이터=mav)
