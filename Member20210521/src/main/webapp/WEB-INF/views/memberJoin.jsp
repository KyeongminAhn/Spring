...
<script>
	function idoverlap() {
		/* 함수의 역할
			- 사용자가 입력한 id값을 백엔드로 보내고 DB에서 중복여부를 확인 후 결과를 가져옴.
		...
		$.ajax({
			...
			success: function(abcd) { // 성공 시 처리할 함수
...
<body>
<!-- 동기식 : 주소, 화면이 바뀌면서 DB를 다녀옴(새로고침)
	비동기식 : 주소, 화면이 바뀌지 않고도 DB를 다녀옴(화면 그대로-더 편리하다.) -->
