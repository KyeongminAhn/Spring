...
<body>
	...
	<!-- 관리자(admin)로 로그인 했을때만 회워목록 링크 노출
		로그인아이디가 admin이면 회원목록 링크가 보이고
		admin이 아니면 보이지 않음. -->
	<div style="background-color:yellow;">
	<c:if test="${sessionScope.loginMember eq 'admin'}">
		<a href="listpage">회원목록조회(관리자전용)</a>
	...
	<!-- 회원정보수정 절차
		정보수정 버튼을 클릭하면 DB로부터 내 정보를 가져와서 memberupdate.jsp에 출력을 하고
		memberupdate.jsp에서 이메일 주소를 수정하고 수정한 내용을 DB에 반영 후 다시 membermain.jsp로 돌아옴. -->
